...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("학생2 - 기말고사 점수 : " + student.average(100,90,80));
        int score2[]  = {100,80,70,65,95};
        System.out.println("학생2 - 최종 점수 : " + student.average(score2));
        ...
        System.out.println("학생3 - 기말고사 점수 : " + student.average(100,90,80));
        int score3[]  = {100,80,70,65,95};
        System.out.println("학생3 - 최종 점수 : " + student.average(score3));
