...
public class LinkedListEx {
    ...
    public static void main(String[] args) {
        ...
        Product produck1 = Product.builder()
                                    .name("아이폰")
                                    .price(5000)
                                    .count(10)
                                    .build();
        Product produck2 = Product.builder()
                                    .name("기계식 키보드")
                                    .price(55000)
                                    .count(20)
                                    .build();
        Product produck3 = Product.builder()
                                    .name("노트북")
                                    .price(15000000)
                                    .count(5)
                                    .build();
        productList.add(produck1);
        productList.add(produck2);
        productList.add(produck3);
